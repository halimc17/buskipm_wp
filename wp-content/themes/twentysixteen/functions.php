...
function twentysixteen_widgets_init() {
	...
	register_sidebar( array(
		'name'          => __( 'Running Text', 'twentysixteen' ),
		'id'            => 'sidebar-4',
		'description'   => __( 'Appears as running text on the top of the page.', 'twentysixteen' ),
		'before_widget' => '<section id="%1$s" class="widget %2$s">',
		'after_widget'  => '</section>',
		'before_title'  => '<h2 class="widget-title">',
		'after_title'   => '</h2>',
	...
	register_sidebar( array(
		'name'          => __( 'Low Content 1', 'twentysixteen' ),
		'id'            => 'sidebar-5',
		'description'   => __( 'Low area content.', 'twentysixteen' ),
		'before_widget' => '<section id="%1$s" class="widget %2$s">',
		'after_widget'  => '</section>',
		'before_title'  => '<h2 class="widget-title">',
		'after_title'   => '</h2>',
